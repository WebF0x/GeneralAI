...
Situation Decision::getSituation()  const
{
    return m_situation;
}
void Decision::setSituation(const Situation& s)
{
    m_situation = s;
}

int Decision::getReaction() const
{
    return m_reaction;
}
void Decision::setReaction(const int r)
{
    m_reaction = r;
}

Result Decision::getResult() const
{
    return m_result;
}
void Decision::setResult(const Result& r)
{
    m_result = r;
}
